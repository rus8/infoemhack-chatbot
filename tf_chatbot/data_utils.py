...
def prepare_custom_data(working_directory, phrases, train_enc, train_dec, test_enc, test_dec, vocabulary_size, tokenizer=None):

    # Create vocabularies of the appropriate sizes.
    vocab_path = os.path.join(working_directory, "joint%d.voc" % vocabulary_size)
    create_vocabulary(vocab_path, phrases, vocabulary_size, tokenizer)
