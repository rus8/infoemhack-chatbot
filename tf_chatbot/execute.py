...
def decode():
  ...
  with tf.Session(config=config) as sess:
    ...
    # Load vocabularies.
    enc_vocab_path = os.path.join(gConfig['working_directory'],"joint%d.voc" % gConfig['enc_vocab_size'])
    dec_vocab_path = os.path.join(gConfig['working_directory'],"joint%d.voc" % gConfig['dec_vocab_size'])
